...
export async function Navbar() {
  ...
  return (
    <nav className="border-b border-zinc-800 bg-zinc-950 sticky top-0 z-50 w-full text-white">
      <div className="container mx-auto flex h-[125px] items-center px-4 justify-between">
        <Link href="/" className="flex items-center">
          <div className="flex items-center text-white hover:text-gray-200 transition-colors">
            <img src="/dpn-logo-stacked.svg?v=4" alt="dentsu podcast network" className="h-[100px] md:h-[120px] w-auto" />
          </div>
        </Link>
