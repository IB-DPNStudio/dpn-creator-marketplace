                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-sm p-4 bg-slate-950 border border-slate-800 shadow-2xl rounded-xl animate-in fade-in zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=closed]:zoom-out-95 text-slate-200">
